...

{
  ...
  "instruction": "Before drafting, privately choose one bounded local historical thread and decide where this passage begins and deliberately stops. Save only a brief high-level composition decision record containing chosen_thread, begins_at, stops_before, intended_material_ids, and intentionally_unused_material_ids. Do not save detailed reasoning. Then draft from your own decision.",
  "historical_material": {
