# Context Packet — T0032-draft-section-P01
...
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/draft.md`, `03_sections/P01/handoff.md`, `tasks/T0032-draft-section-P01/report.md`, `tasks/T0032-draft-section-P01/operator-brief.json`
...
Evidence adapter: `python scripts/draft_evidence.py products/sumer-writing T0032-draft-section-P01 <capability>`.
...
Requested at: 2026-08-25T02:27:37.983415+00:00

## Request

Viết lại toàn bộ P01 bằng reusable harness mới; giữ nguyên mission, entry/exit state và truth ceiling; không tái sử dụng prose bị từ chối; bảo toàn reveal của P02 về usefulness trước continuous speech; tối ưu cho một lần nghe và chỉ dùng chi tiết đã resolve qua evidence broker.
