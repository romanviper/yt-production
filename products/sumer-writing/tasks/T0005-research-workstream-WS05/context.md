# Context Packet — T0005-research-workstream-WS05

- Product: `sumer-writing`
- Operation: `research_workstream`
- Unit: `WS05`
- Allowed writes: `01_research/workstreams/WS05/sources.json`, `01_research/workstreams/WS05/claims.json`, `01_research/workstreams/WS05/synthesis.md`, `tasks/T0005-research-workstream-WS05/report.md`, `tasks/T0005-research-workstream-WS05/operator-brief.json`
...
# BEGIN INPUT: 01_research/workstreams/WS05/brief.md
# WS05 — Functional expansion and human voices

## Question

Writing mở từ các record sớm sang những domain nào, khi nào, và primary voices nào đại diện được?

## In scope

Chronology of administrative/economic, lexical, legal/normative, epistolary, literary/religious and memory-related uses; a bounded set of primary voices illustrating verified functional turns.

## Out of scope

Genre catalogue without causal implication, proof of institutional/power effects owned by WS06, or a general anthology selected only for narrative appeal.

## Ownership

Chứng minh what/when of functional expansion and select evidence-backed voices; WS06 alone owns claims that a recorded domain changed action or power.
...
# END INPUT: 01_research/workstreams/WS05/brief.md
