# Context Packet — T0051-draft-section-P01
...
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/draft.md`, `03_sections/P01/handoff.md`, `tasks/T0051-draft-section-P01/report.md`, `tasks/T0051-draft-section-P01/operator-brief.json`
...
Evidence adapter: `python scripts/draft_evidence.py products/sumer-writing T0051-draft-section-P01 <capability>`.
...
Requested at: 2026-08-25T16:22:12.944546+00:00

## Request

Human duyệt micro-loop kế tiếp. Giữ nguyên 923 từ đã pass. Chỉ thêm 100–150 từ sau câu hỏi writing hay ghi sổ: kéo camera từ một bảng ra vài trăm tablets tìm thấy rải trong tàn tích khu Eanna tại Uruk và quy mô đô thị khoảng 500 hecta; không suy ra toàn dân biết đọc, không dùng quy mô làm bằng chứng nhân quả. Payoff duy nhất: bản ghi chỉ hữu dụng ngoài người tạo ra nếu có ít nhất một cộng đồng biết quy ước. Dừng ngay ở câu hỏi ai có thể đọc và duy trì các quy ước ấy. Một evidence check và một clean viewer chạy song song; tối đa một sửa cục bộ. Không viết tiếp, không sửa harness.
