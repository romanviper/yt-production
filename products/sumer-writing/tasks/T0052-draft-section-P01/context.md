# Context Packet — T0052-draft-section-P01
...
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/draft.md`, `03_sections/P01/handoff.md`, `tasks/T0052-draft-section-P01/report.md`, `tasks/T0052-draft-section-P01/operator-brief.json`
...
Evidence adapter: `python scripts/draft_evidence.py products/sumer-writing T0052-draft-section-P01 <capability>`.
...
Requested at: 2026-08-25T16:34:56.137072+00:00

## Request

Human-approved micro-loop. Preserve the rest of P01 and replace only the opening 120–150 words. Test a show-first opening: one visible artifact, one physical action, and one concrete obstacle; let the viewer see before receiving meaning. Do not invent a protagonist, use second-person role-play, front-load the thesis, or state the civilizational stakes before the scene earns them. Introduce at most one explanation. Do not continue into later beats. Run one evidence check and one clean-viewer check in parallel, allow at most one local correction, then stop for human feedback. Do not modify the harness.
