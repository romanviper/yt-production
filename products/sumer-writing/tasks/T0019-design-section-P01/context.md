# Context Packet — T0019-design-section-P01

- Product: `sumer-writing`
- Operation: `design_section`
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/story-plan.json`, `tasks/T0019-design-section-P01/report.md`, `tasks/T0019-design-section-P01/operator-brief.json`
...
Requested at: 2026-08-13T16:35:59.167088+00:00

## Required changes

P01 hiện chưa đạt. Mở lại story design theo contract mới: chọn structure shape phù hợp thay vì mặc định giữ chuỗi beat cũ; tự đánh giá lại word budget dựa trên narrative load; loại bỏ sự lặp lại payoff giữa các beat; chỉ giữ narrated/support fact thực sự làm câu chuyện tiến lên. Chưa viết lại prose; trả story plan để người dùng duyệt trước.
