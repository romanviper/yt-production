# Context Packet — T0059-draft-section-P01
...
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/draft.md`, `03_sections/P01/handoff.md`, `tasks/T0059-draft-section-P01/report.md`, `tasks/T0059-draft-section-P01/operator-brief.json`
...
Evidence adapter: `python scripts/draft_evidence.py products/sumer-writing T0059-draft-section-P01 <capability>`.
