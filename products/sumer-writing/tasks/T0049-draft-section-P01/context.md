# Context Packet — T0049-draft-section-P01
...
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/draft.md`, `03_sections/P01/handoff.md`, `tasks/T0049-draft-section-P01/report.md`, `tasks/T0049-draft-section-P01/operator-brief.json`
...
Evidence adapter: `python scripts/draft_evidence.py products/sumer-writing T0049-draft-section-P01 <capability>`.
...
Requested at: 2026-08-25T15:51:05.880110+00:00

## Request

Sửa cục bộ prose test P01 hiện tại theo human audit, không đổi route, không viết beat 5 và không sửa harness. Chỉ mô tả token gần hình cầu/bầu dục thực sự thấy trong bulla OIM A64678; đánh dấu rõ camera cắt từ bulla vỡ sang các bulla nguyên vẹn và các trường hợp có dấu số; bỏ khẳng định tuyệt đối rằng phải phá vật để đối chiếu; quy hiệu quả chống can thiệp cho lớp đất sét kết hợp dấu niêm phong. Bỏ hai câu meta về nghe thấy/mang việc phải ghi nhớ, bỏ mã ChM III-937A khỏi narration, và kết bằng câu hỏi năm dấu ấy đang đếm thứ gì. Giữ 450–650 từ, chạy evidence fidelity check và clean listener, rồi dừng chờ human review.
