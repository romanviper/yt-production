# Context Packet — T0030-draft-section-P01
...
- Section: `P01`
- Unit: `-`
- Allowed writes: `03_sections/P01/draft.md`, `03_sections/P01/handoff.md`, `tasks/T0030-draft-section-P01/report.md`, `tasks/T0030-draft-section-P01/operator-brief.json`
...
Additional factual resolution may be requested only through the packet-declared bounded evidence interface.
